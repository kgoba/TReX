...
DEVICE_TYPE = STM32F070x6
STARTUP_FILE = stm32f070x6
SYSTEM_FILE = stm32f0xx
...
INCLUDES = $(LIBINC)
CFLAGS  = $(CPU) $(CMSIS_OPT) $(OTHER_OPT) -Wall -fno-common -fno-strict-aliasing -Os $(INCLUDES) -g -Wfatal-errors -g -ffunction-sections -fdata-sections
CXXFLAGS = $(CFLAGS)
ASFLAGS = $(CFLAGS) -x assembler-with-cpp
LDFLAGS = -Wl,--gc-sections,-Map=$*.map,-cref -T $(LDSCRIPT) $(CPU) --specs=nosys.specs
ARFLAGS = cr
...
OBJS = $(sort \
 $(patsubst %.cpp,%.o,$(wildcard App/*.cpp)) \
